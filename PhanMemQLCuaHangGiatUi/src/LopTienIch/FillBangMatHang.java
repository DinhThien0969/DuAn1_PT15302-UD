 ...
 * @author admin
 */
public class FillBangMatHang extends javax.swing.JPanel {

    /**
     * Creates new form FillBangMatHang
     */
    public FillBangMatHang() {
        initComponents();
        init();
    }
    ...
    void fillTableMatHang() {
        ...
        model.setRowCount(0);
        List<Object[]> list = daomh.getMatHang();
        for (Object[] row : list) {
            model.addRow(row);
        }
    }
