 ...
 * @author admin
 */
public class FillBangNhanVien extends javax.swing.JPanel {

    /**
     * Creates new form FillBangNhanVien
     */
    public FillBangNhanVien() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        tblhoadon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã NV", "Tên NV", "Giới tính", "SĐT", "Email", "Địa chỉ ", "Vai trò"
            }
        ) {
    ...
    void fillTableNhanVien() {
        ...
        model.setRowCount(0);
        List<Object[]> list = daonv.getNhanVien();
        for (Object[] row : list) {
            model.addRow(row);
        }
    }
