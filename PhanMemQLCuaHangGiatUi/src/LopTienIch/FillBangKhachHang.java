 ...
 * @author admin
 */
public class FillBangKhachHang extends javax.swing.JPanel {

    /**
     * Creates new form FillBangKhachHang
     */
    public FillBangKhachHang() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1106, 842));

        jPanel2.setBackground(new java.awt.Color(153, 153, 153));
        jPanel2.setPreferredSize(new java.awt.Dimension(1037, 562));
        ...
        tblhoadon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã KH", "Mã HĐ", "Ten KH", "Giới tính", "Địa chỉ", "Ngày nhận"
            }
        ) {
    ...
    void fillTableKhachHang() {
        ...
        model.setRowCount(0);
        List<Object[]> list = daokh.getKhachHang();
        for (Object[] row : list) {
            model.addRow(row);
        }
    }
